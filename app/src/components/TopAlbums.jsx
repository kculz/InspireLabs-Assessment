...
const TopAlbums = () => {
  ...
  return (
    <div className="top-albums w-full">
                        ...
                        <section className="container mx-auto transform duration-500 p-5">
                            ...
                            <Link to="/albums" className="text-lg text-blue-600">All albums...</Link>
                            </div>
...

                                {
                                    topAlbums.map((album, index) => {
                                        return(
                                            ...
                                            <section className="content bg-cover bg-center h-64 rounded-2xl" style={{backgroundImage: `url(http://127.0.0.1:8000/storage/${album.cover_art})`}}>
                                            ...
                                            {/* <div className="mt-14 px-4">
                                                <h2 className="mt-4 text-base font-medium text-gray-400">{album.title} by {album.artist.name}</h2>
                                                <p className="mt-2 text-2xl text-gray-700">{album.album.title}</p>
                                            </div> */}
                                        </article>
                                        )
                                    })
